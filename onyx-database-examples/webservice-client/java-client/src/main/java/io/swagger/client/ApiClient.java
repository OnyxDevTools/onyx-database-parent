...
public class ApiClient {
    ...
    private static final HttpBasicAuth CREDENTIALS = new HttpBasicAuth();
    static {
    ...
    private String basePath = "http://127.0.0.1:8080/onyx";
    ...
    public ApiClient() {
        ...
        authentications.put("basicAuth", CREDENTIALS);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://onyxdevtools.com:8082/onyx
