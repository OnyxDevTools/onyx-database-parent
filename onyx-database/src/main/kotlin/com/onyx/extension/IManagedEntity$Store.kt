 ...
 * @since 2.0.0
 */
fun IManagedEntity.records(context: SchemaContext, partitionId: Long = partitionId(context), descriptor: EntityDescriptor = descriptor(context)):DiskMap<Any, IManagedEntity> = getDataFile(context, partitionId, descriptor).getHashMap(descriptor.entityClass.name, descriptor.identifier!!.loadFactor.toInt()) as DiskMap<Any, IManagedEntity>
