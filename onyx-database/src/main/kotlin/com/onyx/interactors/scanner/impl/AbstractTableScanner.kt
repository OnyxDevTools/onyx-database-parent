 ...
 */
abstract class AbstractTableScanner constructor(protected val criteria: QueryCriteria<*>, classToScan: Class<*>, protected val descriptor: EntityDescriptor, protected val temporaryDataFile: MapBuilder, protected val query: Query, context: SchemaContext, protected var persistenceManager: PersistenceManager){
