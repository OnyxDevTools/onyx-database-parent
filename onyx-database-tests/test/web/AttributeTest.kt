...
class AttributeTest : BaseTest() {
    ...
    companion object {
        ...
        @JvmStatic
        fun beforeClass() {
            BaseTest.testApplication = WebDatabaseServer("C:/Sandbox/Onyx/Tests/server.oxd")
            BaseTest.testApplication!!.port = 4555
            BaseTest.testApplication!!.webServicePort = 8080
            BaseTest.testApplication!!.setCredentials("admin", "admin")
            BaseTest.testApplication!!.start()
        }
    }
