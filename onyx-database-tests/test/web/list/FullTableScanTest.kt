...
class FullTableScanTest : BaseTest() {
    ...
    fun seedData() {
        ...
        val query = Query(AllAttributeForFetch::class.java)
    ...
    fun testBasicOrsSub() {
        ...
        Assert.assertEquals(4, manager.list<IManagedEntity>(AllAttributeForFetch::class.java, containsSubTes.or(containsSubTestStrin1)).size.toLong())
    }
    ...
    fun testBasicOrSub() {
        ...
        Assert.assertEquals(6, manager.list<IManagedEntity>(AllAttributeForFetch::class.java, stringValueEqualsValue.or(containsSubTes.or(intValueNotEqual2)).or(orStringValueEqualsSomeTest)).size.toLong())
    }
