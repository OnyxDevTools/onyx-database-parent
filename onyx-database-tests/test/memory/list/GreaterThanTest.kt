...
class GreaterThanTest : memory.base.BaseTest() {
    @After
    ...
    fun testStringIDGreaterThan() {
        val criteriaList = QueryCriteria("id", QueryCriteriaOperator.GREATER_THAN, "FIRST ONE1")
    ...
    fun testStringStringGreaterThan() {
        val criteriaList = QueryCriteria("stringValue", QueryCriteriaOperator.GREATER_THAN, "Some test strin2")
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
    ...
    fun testLongGreaterThan() {
        val criteriaList = QueryCriteria("longValue", QueryCriteriaOperator.GREATER_THAN, 322L)
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
        Assert.assertEquals(1, results.size.toLong())
    }
    ...
    fun testPrimitiveLongGreaterThan() {
        val criteriaList = QueryCriteria("longPrimitive", QueryCriteriaOperator.GREATER_THAN, 1002L)
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
        Assert.assertEquals(1, results.size.toLong())
    }
    ...
    fun testIntegerGreaterThan() {
        val criteriaList = QueryCriteria("intValue", QueryCriteriaOperator.GREATER_THAN, 3)
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
        Assert.assertEquals(1, results.size.toLong())
    }
    ...
    fun testPrimitiveIntegerGreaterThan() {
        val criteriaList = QueryCriteria("intPrimitive", QueryCriteriaOperator.GREATER_THAN, 4)
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
    ...
    fun testDoubleGreaterThan() {
        val criteriaList = QueryCriteria("doubleValue", QueryCriteriaOperator.GREATER_THAN, 1.11)
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
        Assert.assertEquals(1, results.size.toLong())
    }
    ...
    fun testPrimitiveDoubleGreaterThan() {
        val criteriaList = QueryCriteria("doublePrimitive", QueryCriteriaOperator.GREATER_THAN, 3.32)
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
        Assert.assertEquals(1, results.size.toLong())
    }
    ...
    fun testDateGreaterThan() {
        val criteriaList = QueryCriteria("dateValue", QueryCriteriaOperator.GREATER_THAN, Date(1001))
        val results = manager.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList)
        Assert.assertEquals(1, results.size.toLong())
    }
