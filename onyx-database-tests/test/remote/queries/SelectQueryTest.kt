...
class SelectQueryTest : RemotePrePopulatedBaseTest() {
    ...
    fun testSelectTwoOrderBy() {
        val criteria = QueryCriteria("stringValue", QueryCriteriaOperator.STARTS_WITH, "Some")
        val query = Query(AllAttributeForFetch::class.java, Arrays.asList("stringValue", "longValue", "intPrimitive"), criteria)
        query.firstRow = 2
        query.maxResults = 2
        ...
        Assert.assertTrue((results[1] as Map<*, *>)["intPrimitive"] as Int == 6)
    }
