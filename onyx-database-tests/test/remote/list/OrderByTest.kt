...
class OrderByTest : RemoteBaseTest() {
    @After
    ...
    fun testOrderByString() {
        ...
        Assert.assertEquals(results[1].id, "FIRST ONE6")
        Assert.assertEquals(results[2].id, "FIRST ONE3")
        Assert.assertEquals(results[3].id, "FIRST ONE2")
        Assert.assertEquals(results[4].id, "FIRST ONE1")
        Assert.assertEquals(results[5].id, "FIRST ONE8")
    }
    ...
    fun testOrderByDoubleDesc() {
        ...
        val results = manager!!.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList, orderList)
        assert(results[0].id == "FIRST ONE3" || results[0].id == "FIRST ONE6")
    }
    ...
    fun testOrderByIntAsc() {
        ...
        val results = manager!!.list<AllAttributeForFetch>(AllAttributeForFetch::class.java, criteriaList, orderList)
        Assert.assertEquals(results[2].id, "FIRST ONE7")
    }
