...
public class IdentifierScanPartitionTest2 extends BasePartitionTest
{
    ...
    public void bTestQueryPartitionEntityWithIndex() throws OnyxException
    {
        ...
        Query query = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.EQUAL, 1l));
    ...
    public void bTestQueryPartitionEntityWithIndexNoDefinedPartitionInQuery() throws OnyxException
    {
        ...
        Query query = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.IN, Arrays.asList(1l,2l)));
    ...
    public void cTestQueryFindQueryPartitionEntityWithIndex() throws OnyxException
    {
        ...
        Query query = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.EQUAL, 1l).and("partitionId", QueryCriteriaOperator.EQUAL, 3l));
    ...
    public void dTestDeleteQueryPartitionEntity() throws OnyxException
    {
        ...
        Query query = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.EQUAL, 1l).and("partitionId", QueryCriteriaOperator.EQUAL, 2l));
    ...
    public void dTestUpdateQueryPartitionEntity() throws OnyxException
    {
        ...
        Query query = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.EQUAL, 2l).and("partitionId", QueryCriteriaOperator.EQUAL, 2l));
    ...
    public void bTestUpdateQueryPartitionEntityWithIndex() throws OnyxException
    {
        ...
        Query query = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.EQUAL, 2l));
        query.setUpdates(Arrays.asList(new AttributeUpdate("indexVal", 6l)));
        query.setPartition(2l);
    ...
    public void bTestUpdatePartitionField() throws OnyxException
    {
        ...
        Query query2 = new Query(entities.partition.FullTablePartitionEntity.class, new QueryCriteria("id", QueryCriteriaOperator.EQUAL, 2l));
