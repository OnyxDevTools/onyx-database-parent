...
public class RelationshipPartitionTest extends BasePartitionTest
{
    ...
    public void testSaveEntityWithRelationshipToOne() throws EntityException
    {
        ...
        Assert.assertTrue(parentToFind.child.id.equals(parent.child.id));
        ...
        Assert.assertTrue(childToFind.parent.id.equals(parent.id));
    }
