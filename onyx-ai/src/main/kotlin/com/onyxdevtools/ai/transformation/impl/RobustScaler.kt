...
private class P2(private val p: Double) : Serializable {
    private val q  = DoubleArray(5)     // marker heights
    private val n  = IntArray(5)        // positions
    private val ns = DoubleArray(5)     // desired positions
    private val d  = doubleArrayOf(0.0, p / 2, p, (1 + p) / 2, 1.0)
    private var count = 0
    ...
    private val Double.sign get() = when { this > 0 -> 1; this < 0 -> -1; else -> 0 }
...
class RobustScaler(
    ...
    private val q25 = P2(0.25)
    private val q50 = P2(0.50)
    private val q75 = P2(0.75)
