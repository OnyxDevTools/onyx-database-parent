 ...
 * ```
 */
class DenseBatchSplitter : BatchSplitter<Array<FlexibleMatrix>, Array<FlexibleMatrix>> {
     ...
     * @param y Target data as an array of FlexibleMatrix where each element corresponds to the target for the same sample in x.
    ...
    override fun splitBatch(
        ...
        y: Array<FlexibleMatrix>,
        testFraction: Double,
        shuffle: Boolean
    ): Quad<Array<FlexibleMatrix>, Array<FlexibleMatrix>, Array<FlexibleMatrix>, Array<FlexibleMatrix>> {
        ...
        fun subset(src: Array<FlexibleMatrix>, ids: List<Int>) = Array(ids.size) { i -> src[ids[i]] }
