 ...
 * ```
 */
class SequentialBatchSplitter : BatchSplitter<Array<Tensor>, List<Tensor>> {
    ...
    override fun splitBatch(
        ...
        testFraction: Float,
        shuffle: Boolean
    ): Quad<Tensor, List<Tensor>, Tensor, List<Tensor>> {
        ...
        fun subsetTargets(src: Array<Tensor>, ids: List<Int>): List<Tensor> =
            ids.map { src[it] }
